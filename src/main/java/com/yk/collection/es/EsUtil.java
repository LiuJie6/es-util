...
public class EsUtil {
     ...
     */
    public JestClient getClient(String esUrl) {
     ...
     * @return 结果对象
     */
    public JestResult createIndex(JestClient jestClient, String indexName) throws Exception {
     ...
     * @throws Exception
     */
    public JestResult indicesExist(JestClient jestClient, String indexName) throws Exception {
     ...
     * @throws Exception
     */
    public JestResult deleteIndex(JestClient jestClient, String indexName) throws Exception {
     ...
     * @return 结果对象
     */
    public JestResult createDocument(JestClient jestClient, String indexName, String typeName, Object source) throws Exception {
     ...
     * @return 结果对象
     */
    public JestResult createDocuments(JestClient jestClient, String indexName, String typeName, List<Object> sources) throws Exception {
     ...
     * @return 查询生成器
     */
    public QueryBuilder matchPhraseQuery(String field, Object text) {
     ...
     * @return 查询生成器
     */
    public QueryBuilder orConditionQuery(List<QueryBuilder> conditions) {
        BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
        for (QueryBuilder condition : conditions) {
     ...
     * @throws IOException
     */
    public <T> List<SearchResult.Hit<T, Void>> search(JestClient jestClient, String indexName, String typeName, Class<T> sourceType, QueryBuilder queryBuilder) throws IOException {
